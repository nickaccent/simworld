...
(function () {
  ...
  const featureDetectionPromise = Promise.resolve(dynamicImportCheck).then(() => {
    ...
    return new Promise((resolve) => {
      ...
      const importMapTest = `<script nonce=${
        nonce || ''
      }>b=(s,type='text/javascript')=>URL.createObjectURL(new Blob([s],{type}));document.head.appendChild(Object.assign(document.createElement('script'),{type:'importmap',nonce:"${nonce}",innerText:\`{"imports":{"x":"\${b('')}"}}\`}));Promise.all([${
  ...
  const s =
    ...
    f =
      'xportmportlassetafromsyncunctionssertvoyiedelecontininstantybreareturdebuggeawaithrwhileforifcatcfinallels';
  let t, c$1, n;
  function parse(l, k = '@') {
    (t = l), (c$1 = k);
            ...
            e: while (1) {
              ...
              a: do {
                switch (s[r >> 1] | 0) {
                  ...
                  case 101: {
                    if (
                      (((s[396] | 0) == 0 ? F(r) | 0 : 0) ? (m((e + 4) | 0, 16, 10) | 0) == 0 : 0)
                        ? (l(), (i[795] | 0) == 0)
                        : 0
                    ) {
                      b = 9;
                ...
                e: while (1) {
                  ...
                  a: do {
                    switch (s[a >> 1] | 0) {
                      ...
                      case 101: {
                        if (
                          ((s[396] | 0) == 0 ? F(a) | 0 : 0) ? (m((e + 4) | 0, 16, 10) | 0) == 0 : 0
                        ) {
                          l();
                          b = 81;
                        } else b = 81;
                      ...
                      case 41: {
                        ...
                        if (
                          (r << 16) >> 16 != 0
                            ? ((o = f[((f[69] | 0) + (((r & 65535) + -1) << 2)) >> 2] | 0),
                              (f[(o + 20) >> 2] | 0) ==
                                (f[((f[68] | 0) + ((a & 65535) << 3) + 4) >> 2] | 0))
                            : 0
                        ) {
                          a = (o + 4) | 0;
                          if (!(f[a >> 2] | 0)) f[a >> 2] = t;
                      ...
                      switch ((r << 16) >> 16) {
                        case 100: {
                          ...
                          if ((a << 16) >> 16 == 97) {
                            a = f[70] | 0;
                            if (
                              (F(a) | 0 ? (m((a + 2) | 0, 58, 8) | 0) == 0 : 0)
                                ? ((t = (a + 10) | 0), D(s[t >> 1] | 0) | 0)
                                : 0
                            ) {
                              f[70] = t;
                              a = w(0) | 0;
    ...
    for (; e.ri(); ) {
      const a = e.is(),
        ...
        c = e.se();
      let n;
      e.ip() && (n = b(-1 === s ? a : a + 1, t.charCodeAt(-1 === s ? a - 1 : a))),
        w.push({ n: n, s: a, e: r, ss: f, se: c, d: s, a: i });
    }
    for (; e.re(); ) {
      const a = e.es(),
        r = e.ee(),
    ...
    switch ((++n, e)) {
      ...
      case 117:
        return (function () {
          let e;
          123 === t.charCodeAt(n)
            ? (++n, (e = k(t.indexOf('}', n) - n)), ++n, e > 1114111 && o())
            : (e = k(4));
          return e <= 65535
  ...
  function o() {
    throw Object.assign(
      Error(
        `Parse error ${c$1}:${t.slice(0, n).split('\n').length}:${n - t.lastIndexOf('\n', n - 1)}`,
      ),
      { idx: n },
    );
  }
  ...
  const hasNext = (script) =>
    script.nextSibling || (script.parentNode && hasNext(script.parentNode));
